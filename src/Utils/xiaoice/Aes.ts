export class Aes {
  static encrypt(msg: string, arg1: string, arg2: number) {
    return a(msg, arg1, arg2);
  }
};
function i(n, i) {
  for (var s, c, e = 4, l = i.length / e - 1, r = [
    [],
    [],
    [],
    []
  ], o = 0; o < 4 * e; o++) r[o % 4][Math.floor(o / 4)] = n[o];
  for (r = t(r, i, 0, e), s = 1; s < l; s++) r = u(r, e), r = f(r, e), r = h(r), r = t(r, i, s, e);
